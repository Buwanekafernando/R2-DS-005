...
from utils.pain_point_extractor import extract_pain_points_detailed, get_extractor
from utils.review_reader import get_product_pain_profile
...
with col_left:
    ...
    with st.container():
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))
        # dataset file lives in backend/dataset/sample_products.json
        sample_file = os.path.join(script_dir, "dataset", "sample_products.json")
